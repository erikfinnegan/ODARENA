...
*/
    ...
    public function getTotalUnitsForSlot(Dominion $dominion, int $slot): int
    {
        return (
            ...
            $this->queueService->getReturningQueueTotalByResource($dominion, "military_unit{$slot}") +
            $this->queueService->getInvadingQueueTotalByResource($dominion, "military_unit{$slot}")
        );
    }
    ...
    public function hasReturningUnits(Dominion $dominion): bool
    {
        ...
        for ($slot = 1; $slot <= 4; $slot++)
        {
          $hasReturningUnits += $this->queueService->getReturningQueueTotalByResource($dominion, "military_unit{$slot}");
        }
