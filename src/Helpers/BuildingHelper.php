...
class BuildingHelper
{
    ...
    public function getBuildingHelpString(string $buildingType): string
    {
        $helpStrings = [
            ...
            'wizard_guild' => ['Houses 40 wizards, Arch Mages, and units that count as wizards (not affected by population bonus).', 'Wizard Strength refresh rate increased by 0.1% per 1% owned (max +2% at 20% owned).','Wizard and ArchMage training and spell costs reduced by 2% per 1% owned (maximum 40% at 20% owned).'],
            ...
            'forest_haven' => ['Houses 40 spies and units that count as spies (not affected by population bonus).','Failed spy ops losses reduced by 3% per 1% owned, up to a maximum of 30% at 10% owned.','Fireball damage and platinum theft reduced by 8% per 1% owned.'],
