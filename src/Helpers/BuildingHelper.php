...
class BuildingHelper
{
    ...
    public function getBuildingHelpString(string $buildingType): string
    {
        $helpStrings = [
            ...
            'forest_haven' => ['Houses 40 spies and units that count as spies (increased by Hideouts improvements), including units in training.','Failed spy ops losses reduced by 3% per 1% owned, up to a maximum of 30% at 10% owned.','Fireball damage and platinum theft reduced by 8% per 1% owned.'],
