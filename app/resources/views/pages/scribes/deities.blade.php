...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <p>The range multiplier is the maximum land size range the deity permits you to interact with, unless recently invaded. A dominion with a wider range cannot take actions against a dominion with a more narrow range, unless the two ranges overlap.</p>
        </div>
    </div>
