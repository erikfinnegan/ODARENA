                                                ...
                                                @if ($gameEvent->source_type === \OpenDominion\Models\Dominion::class && in_array($gameEvent->source_id, $dominionIds, true))
                                                    @if ($gameEvent->data['result']['success'])
                                                        @if(isset($gameEvent->data['attacker']['liberation']) and $gameEvent->data['attacker']['liberation'])
                                                            ...
                                                            <span class="text-aqua"><a href="{{ route('dominion.insight.show', [$gameEvent->source->id]) }}">{{ $gameEvent->source->name }}</a> <a href="{{ route('dominion.realm', [$gameEvent->source->realm->number]) }}">(#{{ $gameEvent->source->realm->number }})</a></span>
                                                            liberated
                                                ...
                                                @elseif ($gameEvent->target_type === \OpenDominion\Models\Dominion::class)
                                                    ...
                                                    @else
                                                        @if ($gameEvent->source_realm_id == $selectedDominion->realm_id)
                                                            Fellow dominion
                                                        @endif
                                                        <span class="text-aqua"><a href="{{ route('dominion.insight.show', [$gameEvent->target->id]) }}">{{ $gameEvent->target->name }}</a> <a href="{{ route('dominion.realm', [$gameEvent->target->realm->number]) }}">(#{{ $gameEvent->target->realm->number }})</a></span>
