        ...
        <div class="col-sm-12 col-md-3">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <p>Gold, lumber and ore trade 2 for 1.<br>Gems trade for 1:2 gold, lumber or ore.<br>Food trades for 1:4 gold, lumber or ore.</p>
                    <p>You have {{ number_format($selectedDominion->resource_gold) }} gold, {{ number_format($selectedDominion->resource_lumber) }} lumber, {{ number_format($selectedDominion->resource_ore) }} ore and {{ number_format($selectedDominion->resource_gems) }} {{ str_plural('gem', $selectedDominion->resource_gems) }}.</p>
                </div>
            </div>
        </div>
