        ...
        <div class="col-sm-12 col-md-3">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <p>You have <b>{{ number_format($selectedDominion->xp) }} XP</b>, which is increasing your ruler title bonus by {{ number_format(($selectedDominion->title->getPerkBonus($selectedDominion)-1)*100,2) }}%.</p>
